...
cdef class BindingRule(Variable):
    cdef:
        ...
        PField keyField # resultField?
        
        getAll(BindingRule self, query, QueryContext result)
    
    cdef inline getAllRecursively(BindingRule self, query, QueryContext result):
...
cdef class QueryContext(object):
    cdef: 
        ...
        inline setattr(self, name, value): self.dick[name] = value        
        inline getattr(self, name       ): return self.dick[name]
