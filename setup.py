...
setup(
    ...
    #  One Extension per pyx file; the name of the pyx file must be extensionName + ".pyx"
    ext_modules = cythonize([ Extension(modname, ['src/'+s for s in sources] ) for modname, sources in 
