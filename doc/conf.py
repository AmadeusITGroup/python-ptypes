# -*- coding: utf-8 -*-
#
# ptypes documentation build configuration file, created by
...
version = pkg_resources.get_distribution('ptypes').version
...
latex_documents = [
  ('index', 'ptypes.tex', u'ptypes Documentation',
   u'Dénes Vadász', 'manual'),
]
...
man_pages = [
    ('index', 'ptypes', u'ptypes Documentation',
     [u'Dénes Vadász'], 1)
]
...
texinfo_documents = [
  ('index', 'ptypes', u'ptypes Documentation',
   u'Dénes Vadász', 'ptypes', 'One line description of project.',
   'Miscellaneous'),
]
